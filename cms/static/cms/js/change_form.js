(function($) {
	$(document).ready(function() {
		...
		$('#page_form').submit(function(){
			if($('iframe').length){
				var question = gettext("Not all components are saved. Are you sure you want to save the page?\nYou may lose your changes. To prevent that, press 'Cancel' and save every unsaved component first.");
