# -*- coding: utf-8 -*-
from cms.admin.dialog.forms import (
    PermissionAndModeratorForm, PermissionForm, ModeratorForm)
...
def get_copy_dialog(request, page_id):
    ...
    target = get_object_or_404(Page, pk=request_item(request, 'target'))
    ...
    context = {
        ...
        'callback': request_item(request, 'callback'),
    }
