...
class Video(CMSPlugin):
    # player settings
    movie = models.FileField(_('movie file'), upload_to=get_plugin_media_path, help_text=_('use .flv file or h264 encoded video file'), blank=True, null=True)
    ...
    image = models.ImageField(_('image'), upload_to=get_plugin_media_path, help_text=_('preview image file'), null=True, blank=True)
